...
export default function Home() {
    ...
    return ( <
        ...
        Layout setShowWalletModal = { setShowWalletModal } setShowSelectWallet = { setShowSelectWallet } walletConnected = { walletConnected } setWalletConnected = { setWalletConnected } >
        ...
        Want to join our referral program ? Earn money towards the fund.The more people you refer and more money you bring in , the quicker your partner level grows, which will allow you to have early insights, earn higher $ on dollars brought in , and more. <
        /div> <
